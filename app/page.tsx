  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Overview of your Uber finances</p>
      </div>
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <div className="mt-4 space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-white font-semibold">${stats.totalIncome.toFixed(2)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Total Costs</span>
              <span className="text-white font-semibold">${(stats.totalExpenses + stats.loansPaid).toFixed(2)}</span>
            </div>
            <div className="h-px bg-gray-800"></div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400 font-bold">Net Profit</span>
              <span className={`font-bold text-lg ${stats.netProfit >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <Card>
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Loan Burden</span>
              <span className="text-white font-semibold">
